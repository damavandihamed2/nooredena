...
# powerbi_database = database.powerbi_database
...
# companies = pd.read_sql(query_companies, powerbi_database)
#
...
# tsetmc_mapper = pd.read_sql("SELECT * FROM [nooredenadb].[codal].[tsetmc_mapper]", powerbi_database)
