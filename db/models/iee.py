...
class IeeIeeDataHistorical(Base):
    ...
    __table_args__ = {"schema": "iee"}

    auctionIdn: Optional[int] = Column(Integer, nullable=False, primary_key=True)
    auctionDateShamsi: Optional[str] = Column(String(55), nullable=True)
    tradeDateShamsi: Optional[str] = Column(String(55), nullable=False, primary_key=True)
    ...
    tradeTypeTitle: Optional[str] = Column(String(55), nullable=False, primary_key=True)
